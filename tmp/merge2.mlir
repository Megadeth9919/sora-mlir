module @Sora {
  func.func @main(%arg0: tensor<2x11340x1152xf16>, %arg1: tensor<1x224x1152xf16>, %arg2: tensor<2x6912xf16>) -> tensor<2x11340x1152xf16> {
    ...
    %3 = "sora.View"(%2) <{shape = [1, 224, 1152]}> : (tensor<1x224x1152xsi8>) -> tensor<1x224x1152xf16>
    ...
    %9 = "sora.Layernorm"(%8) <{dynamic_scale = false}> : (tensor<22680x1152xf16>) -> tensor<2x11340x1152xf16>
    %10 = "sora.View"(%9) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xf16>
    ...
    %19 = "sora.LinearW8"(%18, %16, %17) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<1152x1152xsi8>, tensor<1152xf16>) -> tensor<56x405x1152xf16>
    %20 = "sora.View"(%19) <{shape = [56, 405, 1152]}> : (tensor<56x405x1152xf16>) -> tensor<56x405x1152xsi8>
    %21 = "sora.Weight"() : () -> tensor<1152xf16>
    %22 = "sora.View"(%15) <{shape = [22680, 1152]}> : (tensor<56x405x1152xsi8>) -> tensor<22680x1152xsi8>
    %23 = "sora.LinearW8"(%22, %arg0, %21) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<2x11340x1152xf16>, tensor<1152xf16>) -> tensor<56x405x1152xf16>
    %24 = "sora.View"(%23) <{shape = [56, 405, 1152]}> : (tensor<56x405x1152xf16>) -> tensor<56x405x1152xsi8>
    %25 = "sora.Weight"() : () -> tensor<1152xf16>
    %26 = "sora.View"(%15) <{shape = [22680, 1152]}> : (tensor<56x405x1152xsi8>) -> tensor<22680x1152xsi8>
    %27 = "sora.LinearW8"(%26, %arg2, %25) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<2x6912xf16>, tensor<1152xf16>) -> tensor<56x405x1152xf16>
    %28 = "sora.View"(%27) <{shape = [56, 405, 1152]}> : (tensor<56x405x1152xf16>) -> tensor<56x405x1152xsi8>
    ...
    %36 = "sora.Rmsnorm"(%35) <{dynamic_scale = false}> : (tensor<362880x72xf16>) -> tensor<56x16x405x72xf16>
    %37 = "sora.View"(%36) <{shape = [56, 16, 405, 72]}> : (tensor<56x16x405x72xf16>) -> tensor<56x16x405x72xf16>
    %38 = "sora.View"(%33) <{shape = [362880, 72]}> : (tensor<56x16x405x72xf16>) -> tensor<362880x72xf16>
    %39 = "sora.Rmsnorm"(%38) <{dynamic_scale = true}> : (tensor<362880x72xf16>) -> tensor<56x16x405x72xsi8>
    %40 = "sora.View"(%39) <{shape = [56, 16, 405, 72]}> : (tensor<56x16x405x72xsi8>) -> tensor<56x16x405x72xf16>
    ...
    %45 = "sora.Softmax"(%44) <{dim = -1 : si32, dynamic_scale = true}> : (tensor<362880x405xf16>) -> tensor<56x16x405x405xsi8>
    %46 = "sora.View"(%45) <{shape = [56, 16, 405, 405]}> : (tensor<56x16x405x405xsi8>) -> tensor<56x16x405x405xf16>
    ...
    %49 = "sora.Convert"(%48) <{dynamic_scale = true}> : (tensor<64512x405xf16>) -> tensor<56x16x72x405xsi8>
    %50 = "sora.View"(%49) <{shape = [56, 16, 72, 405]}> : (tensor<56x16x72x405xsi8>) -> tensor<56x16x72x405xf16>
    ...
    %55 = "sora.Convert"(%54) <{dynamic_scale = true}> : (tensor<22680x1152xf16>) -> tensor<56x405x1152xsi8>
    %56 = "sora.View"(%55) <{shape = [56, 405, 1152]}> : (tensor<56x405x1152xsi8>) -> tensor<56x405x1152xf16>
    %57 = "sora.View"(%56) <{shape = [22680, 1152]}> : (tensor<56x405x1152xf16>) -> tensor<22680x1152xf16>
    %58 = "sora.LinearW8"(%57, %7#0, %7#2) <{do_bias = true}> : (tensor<22680x1152xf16>, tensor<2x1x1152xf16>, tensor<2x1x1152xf16>) -> tensor<56x405x1152xf16>
    %59 = "sora.View"(%58) <{shape = [56, 405, 1152]}> : (tensor<56x405x1152xf16>) -> tensor<56x405x1152xf16>
    ...
    %64 = "sora.Convert"(%63) <{dynamic_scale = true}> : (tensor<22680x1152xf16>) -> tensor<2x11340x1152xsi8>
    %65 = "sora.View"(%64) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xsi8>) -> tensor<2x11340x1152xf16>
    %66 = "sora.View"(%65) <{shape = [22680, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<22680x1152xf16>
    %67 = "sora.LinearW8"(%66, %7#3, %7#5) <{do_bias = true}> : (tensor<22680x1152xf16>, tensor<2x1x1152xf16>, tensor<2x1x1152xf16>) -> tensor<2x11340x1152xf16>
    %68 = "sora.View"(%67) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xf16>
    %69 = "sora.View"(%3) <{shape = [224, 1152]}> : (tensor<1x224x1152xf16>) -> tensor<224x1152xf16>
    %70 = "sora.LinearW8"(%69, %10, %13) <{do_bias = true}> : (tensor<224x1152xf16>, tensor<2x11340x1152xf16>, tensor<2x11340x1152xf16>) -> tensor<1x224x1152xf16>
    %71 = "sora.View"(%70) <{shape = [1, 224, 1152]}> : (tensor<1x224x1152xf16>) -> tensor<1x224x1152xf16>
    %72 = "sora.View"(%3) <{shape = [224, 1152]}> : (tensor<1x224x1152xf16>) -> tensor<224x1152xf16>
    %73 = "sora.LinearW8"(%72, %14, %15) <{do_bias = true}> : (tensor<224x1152xf16>, tensor<2x11340x1152xsi8>, tensor<56x405x1152xsi8>) -> tensor<1x224x1152xf16>
    %74 = "sora.View"(%73) <{shape = [1, 224, 1152]}> : (tensor<1x224x1152xf16>) -> tensor<1x224x1152xf16>
    ...
    %84 = "sora.Convert"(%83) <{dynamic_scale = true}> : (tensor<3584x72xf16>) -> tensor<1x16x224x72xsi8>
    %85 = "sora.View"(%84) <{shape = [1, 16, 224, 72]}> : (tensor<1x16x224x72xsi8>) -> tensor<1x16x224x72xf16>
    ...
    %90 = "sora.Softmax"(%89) <{dim = -1 : si32, dynamic_scale = true}> : (tensor<362880x224xf16>) -> tensor<1x16x22680x224xsi8>
    %91 = "sora.View"(%90) <{shape = [1, 16, 22680, 224]}> : (tensor<1x16x22680x224xsi8>) -> tensor<1x16x22680x224xf16>
    ...
    %94 = "sora.Convert"(%93) <{dynamic_scale = true}> : (tensor<1152x224xf16>) -> tensor<1x16x72x224xsi8>
    %95 = "sora.View"(%94) <{shape = [1, 16, 72, 224]}> : (tensor<1x16x72x224xsi8>) -> tensor<1x16x72x224xf16>
    ...
    %100 = "sora.Convert"(%99) <{dynamic_scale = true}> : (tensor<22680x1152xf16>) -> tensor<2x11340x1152xsi8>
    %101 = "sora.View"(%100) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xsi8>) -> tensor<2x11340x1152xf16>
    %102 = "sora.Weight"() : () -> tensor<1152x1152xsi8>
    %103 = "sora.View"(%101) <{shape = [22680, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<22680x1152xf16>
    %104 = "sora.LinearW8"(%103, %102, %24) <{do_bias = true}> : (tensor<22680x1152xf16>, tensor<1152x1152xsi8>, tensor<56x405x1152xsi8>) -> tensor<2x11340x1152xf16>
    %105 = "sora.View"(%104) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xf16>
    ...
    %108 = "sora.Layernorm"(%107) <{dynamic_scale = false}> : (tensor<22680x1152xf16>) -> tensor<2x11340x1152xf16>
    %109 = "sora.View"(%108) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xf16>
    ...
    %115 = "sora.LinearW8"(%114, %29, %31) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<56x405x16x72xf16>, tensor<56x405x16x72xf16>) -> tensor<2x11340x4608xf16>
    %116 = "sora.View"(%115) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x4608xf16>) -> tensor<2x11340x1152xsi8>
    %117 = "sora.View"(%116) <{shape = [22680, 1152]}> : (tensor<2x11340x1152xsi8>) -> tensor<22680x1152xsi8>
    %118 = "sora.Gelu"(%117) <{dynamic_scale = true}> : (tensor<22680x1152xsi8>) -> tensor<2x11340x4608xsi8>
    %119 = "sora.View"(%118) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x4608xsi8>) -> tensor<2x11340x1152xsi8>
    %120 = "sora.View"(%119) <{shape = [22680, 1152]}> : (tensor<2x11340x1152xsi8>) -> tensor<22680x1152xsi8>
    %121 = "sora.LinearW8"(%120, %32, %34) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<56x16x405x72xf16>, tensor<56x16x405x72xf16>) -> tensor<2x11340x1152xf16>
    %122 = "sora.View"(%121) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xsi8>
    ...
    %131 = "sora.Layernorm"(%130) <{dynamic_scale = false}> : (tensor<22680x1152xf16>) -> tensor<2x11340x1152xf16>
    %132 = "sora.View"(%131) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xf16>
    ...
    %142 = "sora.LinearW8"(%141, %40, %140) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<56x16x405x72xf16>, tensor<1152xf16>) -> tensor<810x28x1152xf16>
    %143 = "sora.View"(%142) <{shape = [810, 28, 1152]}> : (tensor<810x28x1152xf16>) -> tensor<810x28x1152xsi8>
    %144 = "sora.View"(%139) <{shape = [22680, 1152]}> : (tensor<810x28x1152xsi8>) -> tensor<22680x1152xsi8>
    %145 = "sora.LinearW8"(%144, %42, %43) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<56x16x405x72xsi8>, tensor<56x16x405x405xf16>) -> tensor<810x28x1152xf16>
    %146 = "sora.View"(%145) <{shape = [810, 28, 1152]}> : (tensor<810x28x1152xf16>) -> tensor<810x28x1152xsi8>
    %147 = "sora.View"(%139) <{shape = [22680, 1152]}> : (tensor<810x28x1152xsi8>) -> tensor<22680x1152xsi8>
    %148 = "sora.LinearW8"(%147, %46, %47) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<56x16x405x405xf16>, tensor<56x16x72x405xf16>) -> tensor<810x28x1152xf16>
    %149 = "sora.View"(%148) <{shape = [810, 28, 1152]}> : (tensor<810x28x1152xf16>) -> tensor<810x28x1152xsi8>
    ...
    %157 = "sora.Rmsnorm"(%156) <{dynamic_scale = false}> : (tensor<362880x72xf16>) -> tensor<810x16x28x72xf16>
    %158 = "sora.View"(%157) <{shape = [810, 16, 28, 72]}> : (tensor<810x16x28x72xf16>) -> tensor<810x16x28x72xf16>
    %159 = "sora.View"(%154) <{shape = [362880, 72]}> : (tensor<810x16x28x72xf16>) -> tensor<362880x72xf16>
    %160 = "sora.Rmsnorm"(%159) <{dynamic_scale = false}> : (tensor<362880x72xf16>) -> tensor<810x16x28x72xf16>
    %161 = "sora.View"(%160) <{shape = [810, 16, 28, 72]}> : (tensor<810x16x28x72xf16>) -> tensor<810x16x28x72xf16>
    ...
    %165 = "sora.Convert"(%164) <{dynamic_scale = true}> : (tensor<362880x72xf16>) -> tensor<810x16x28x72xsi8>
    %166 = "sora.View"(%165) <{shape = [810, 16, 28, 72]}> : (tensor<810x16x28x72xsi8>) -> tensor<810x16x28x72xf16>
    ...
    %171 = "sora.Softmax"(%170) <{dim = -1 : si32, dynamic_scale = true}> : (tensor<362880x28xf16>) -> tensor<810x16x28x28xsi8>
    %172 = "sora.View"(%171) <{shape = [810, 16, 28, 28]}> : (tensor<810x16x28x28xsi8>) -> tensor<810x16x28x28xf16>
    ...
    %175 = "sora.Convert"(%174) <{dynamic_scale = true}> : (tensor<933120x28xf16>) -> tensor<810x16x72x28xsi8>
    %176 = "sora.View"(%175) <{shape = [810, 16, 72, 28]}> : (tensor<810x16x72x28xsi8>) -> tensor<810x16x72x28xf16>
    ...
    %181 = "sora.Convert"(%180) <{dynamic_scale = true}> : (tensor<22680x1152xf16>) -> tensor<810x28x1152xsi8>
    %182 = "sora.View"(%181) <{shape = [810, 28, 1152]}> : (tensor<810x28x1152xsi8>) -> tensor<810x28x1152xf16>
    %183 = "sora.View"(%182) <{shape = [22680, 1152]}> : (tensor<810x28x1152xf16>) -> tensor<22680x1152xf16>
    %184 = "sora.LinearW8"(%183, %52, %56) <{do_bias = true}> : (tensor<22680x1152xf16>, tensor<56x405x16x72xf16>, tensor<56x405x1152xf16>) -> tensor<810x28x1152xf16>
    %185 = "sora.View"(%184) <{shape = [810, 28, 1152]}> : (tensor<810x28x1152xf16>) -> tensor<810x28x1152xf16>
    ...
    %192 = "sora.Convert"(%191) <{dynamic_scale = true}> : (tensor<22680x1152xf16>) -> tensor<2x11340x1152xsi8>
    %193 = "sora.View"(%192) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xsi8>) -> tensor<2x11340x1152xf16>
    %194 = "sora.Weight"() : () -> tensor<1152x1152xsi8>
    %195 = "sora.View"(%193) <{shape = [22680, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<22680x1152xf16>
    %196 = "sora.LinearW8"(%195, %194, %60) <{do_bias = true}> : (tensor<22680x1152xf16>, tensor<1152x1152xsi8>, tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xf16>
    %197 = "sora.View"(%196) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xf16>
    %198 = "sora.View"(%3) <{shape = [224, 1152]}> : (tensor<1x224x1152xf16>) -> tensor<224x1152xf16>
    %199 = "sora.LinearW8"(%198, %61, %65) <{do_bias = true}> : (tensor<224x1152xf16>, tensor<2x11340x1152xf16>, tensor<2x11340x1152xf16>) -> tensor<1x224x1152xf16>
    %200 = "sora.View"(%199) <{shape = [1, 224, 1152]}> : (tensor<1x224x1152xf16>) -> tensor<1x224x1152xf16>
    %201 = "sora.Weight"() : () -> tensor<1152x1152xsi8>
    %202 = "sora.View"(%3) <{shape = [224, 1152]}> : (tensor<1x224x1152xf16>) -> tensor<224x1152xf16>
    %203 = "sora.LinearW8"(%202, %201, %71) <{do_bias = true}> : (tensor<224x1152xf16>, tensor<1152x1152xsi8>, tensor<1x224x1152xf16>) -> tensor<1x224x1152xf16>
    %204 = "sora.View"(%203) <{shape = [1, 224, 1152]}> : (tensor<1x224x1152xf16>) -> tensor<1x224x1152xf16>
    ...
    %214 = "sora.Convert"(%213) <{dynamic_scale = true}> : (tensor<3584x72xf16>) -> tensor<1x16x224x72xsi8>
    %215 = "sora.View"(%214) <{shape = [1, 16, 224, 72]}> : (tensor<1x16x224x72xsi8>) -> tensor<1x16x224x72xf16>
    ...
    %220 = "sora.Softmax"(%219) <{dim = -1 : si32, dynamic_scale = true}> : (tensor<362880x224xf16>) -> tensor<1x16x22680x224xsi8>
    %221 = "sora.View"(%220) <{shape = [1, 16, 22680, 224]}> : (tensor<1x16x22680x224xsi8>) -> tensor<1x16x22680x224xf16>
    ...
    %224 = "sora.Convert"(%223) <{dynamic_scale = true}> : (tensor<1152x224xf16>) -> tensor<1x16x72x224xsi8>
    %225 = "sora.View"(%224) <{shape = [1, 16, 72, 224]}> : (tensor<1x16x72x224xsi8>) -> tensor<1x16x72x224xf16>
    ...
    %230 = "sora.Convert"(%229) <{dynamic_scale = true}> : (tensor<22680x1152xf16>) -> tensor<2x11340x1152xsi8>
    %231 = "sora.View"(%230) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xsi8>) -> tensor<2x11340x1152xf16>
    %232 = "sora.View"(%231) <{shape = [22680, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<22680x1152xf16>
    %233 = "sora.LinearW8"(%232, %74, %76) <{do_bias = true}> : (tensor<22680x1152xf16>, tensor<1x224x1152xf16>, tensor<1x224x16x72xf16>) -> tensor<2x11340x1152xf16>
    %234 = "sora.View"(%233) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xf16>
    ...
    %237 = "sora.Layernorm"(%236) <{dynamic_scale = false}> : (tensor<22680x1152xf16>) -> tensor<2x11340x1152xf16>
    %238 = "sora.View"(%237) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xf16>
    ...
    %244 = "sora.LinearW8"(%243, %78, %80) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<1x16x22680x72xf16>, tensor<1x16x224x72xf16>) -> tensor<2x11340x4608xf16>
    %245 = "sora.View"(%244) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x4608xf16>) -> tensor<2x11340x1152xsi8>
    %246 = "sora.View"(%245) <{shape = [22680, 1152]}> : (tensor<2x11340x1152xsi8>) -> tensor<22680x1152xsi8>
    %247 = "sora.Gelu"(%246) <{dynamic_scale = true}> : (tensor<22680x1152xsi8>) -> tensor<2x11340x4608xsi8>
    %248 = "sora.View"(%247) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x4608xsi8>) -> tensor<2x11340x1152xsi8>
    ...
    %252 = "sora.LinearW8"(%251, %249, %250) <{do_bias = true}> : (tensor<22680x1152xsi8>, tensor<1152x4608xsi8>, tensor<1152xf16>) -> tensor<2x11340x1152xf16>
    %253 = "sora.View"(%252) <{shape = [2, 11340, 1152]}> : (tensor<2x11340x1152xf16>) -> tensor<2x11340x1152xsi8>
